...
```
Note: Just added follow up questions with the Ai, for diving deeper into the grammar, and made a few small changes like being able to chose more ai(s) then just Groq. And bookmarking grammar.
